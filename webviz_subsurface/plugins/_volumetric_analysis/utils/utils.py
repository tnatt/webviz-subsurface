...
def move_to_end_of_list(element, list_of_elements):
    return [x for x in list_of_elements if x != element] + [element]


def move_to_start_of_list(element, list_of_elements):
    return [element] + [x for x in list_of_elements if x != element]
