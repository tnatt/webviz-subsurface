...
class RftPlotter(WebvizPluginABC):
                            ...
                            children=[
                                ...
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        wcc.Graph(id=self.uuid("crossplot")),
                                    ],
                                ),
                            ],
                        ),
    ...
    def set_callbacks(self, app):
        ...
        @app.callback(
            Output(self.uuid("crossplot"), "figure"),
            [
        ...
        def crossplot(wells, sizeby, colorby):

            return update_crossplot(self.ertdatadf, wells, sizeby, colorby)
